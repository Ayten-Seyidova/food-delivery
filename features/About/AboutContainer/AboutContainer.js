    ...
    <>
      <AboutUs>
        ...
        <AboutRight>
          ...
          <CardContainer style={{ marginTop: "-9%", marginLeft: "-20%" }}>
            <Card></Card>
            <CardFood>
          ...
          <CardContainer style={{ marginTop: "10%", marginLeft: "20%" }}>
            <Card></Card>
            <CardFood>
              <img src={soup} style={{ width: 120, height: 118, borderRadius:'50%' }} />
            </CardFood>
            <CardDetail>
              <h4
                style={{ fontWeight: 600, fontSize: 22, fontFamily: "Mukta" }}
          ...
          <CardContainer style={{ marginTop: "35%", marginLeft: "-20%" }}>
            <Card></Card>
            <CardFood>
              <img
                src={coffee}
